...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2026 at 10:11 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_authenticate_user` (IN `p_identifier` VARCHAR(255))   BEGIN
...
(2, 'APP-00045', NULL, 1, 'SRI RAMBALAJI GASES PVT LTD', NULL, NULL, NULL, NULL, 'HR &amp; Training Section', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '100/6,PERUNDURAI ROAD,ERODE', NULL, '8891608696', 'kochinairproducts@gmail.com', '', '7654321', 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'approved', '2026-05-19 18:57:42', '2026-05-19 19:26:28', 'NO', 'YES', 'Skilled', '9876543', '2026-05-21', '2026-05-31', 30, 20, 'Skilled', '98765432', 'arjun', '2026-05-21', '2026-06-07', '98765432', '0987654321234', 'Shree Sharma', 'ok');
...
(34, 'APP-00045', 26, '3a_submitted', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', NULL, '2026-05-18 06:24:00', '2026-05-18 06:24:00');
...
CREATE TABLE `contractors` (
  ...
  `epf_esi_exemption_reason` text DEFAULT NULL,
  `wage_declaration` varchar(100) DEFAULT NULL,
  `ecp_number` varchar(100) DEFAULT NULL,
  `ecp_valid_from` date DEFAULT NULL,
  `ecp_valid_to` date DEFAULT NULL,
...
INSERT INTO `contractor_so_selection` (`id`, `contractor_id`, `sale_order_no`, `created_at`) VALUES
(1, 1, 'SO-2026-0002', '2026-05-19 18:57:42'),
(2, 1, 'SO-2026-0002', '2026-05-19 18:57:42');
